...
$primoSearch = "https://miami-primo.hosted.exlibrisgroup.com/primo_library/libweb/action/dlSearch.do";
?>
...
<div id="header-content"> 
    <div class="pure-g header-content">
        ...
        <div class="pure-u-1 pure-u-md-1-5">
          <a href="<?php print PATH_FROM_ROOT; ?>/index.php"><img src="<?php print THEME_BASE_DIR; ?>images/logo.png" alt="University of Miami Libraries" /></a>
        ...
        <div class="pure-u-1 pure-u-md-1-5 visible-desktop">
          <img src="<?php print THEME_BASE_DIR; ?>images/talk_bubble_green.png" alt="talk back" />
          ...
          <ul class="nav" id="nav_menu">
              ...
              <li class="mega"><a href="<?php print PATH_FROM_ROOT; ?>/books/">BOOKS</a>
                  ...
                  <div class="mega_child mega-md mega-left">
                    ...
                    <ul>
                      <li><a href="https://miami-primo.hosted.exlibrisgroup.com/primo_library/libweb/action/search.do?vid=uml">Catalog home</a></li>
                      <li class="last"><a href="<?php print PATH_FROM_ROOT; ?>/newitems/index.php?src=richter&display=grid">New Items</a></li>
                    </ul>
                    <ul>
                      <li><a href="https://uofmiami.overdrive.com/">Overdrive E-Books</a></li>
                    </ul>
              ...
              <li class="mega"><a href="<?php print PATH_FROM_ROOT; ?>/articles/">ARTICLES</a>
                  ...
                  <script type="text/javascript">                                        
                      ...
                      <ul>
                        <li class="last"><a href="https://miami-primo.hosted.exlibrisgroup.com/primo_library/libweb/action/dlSearch.do?institution=01UOML&vid=uml&query=facet_atoz%2cexact%2cA&indx=1&bulkSize=30&dym=false&loc=local%2cscope%3a%28AZ01UOML%29&fn=goAlmaAz&sortField=stitle&almaAzSearch=true&azSearch=true&selectedAzAlmaLetter=A">Journal List</a></li>
                      </ul>
              ...
              <li class="libraries mega"><a href="<?php print PATH_FROM_ROOT; ?>/libraries-collections/">LIBRARIES &amp; COLLECTIONS</a>
                  ...
                  <div class="mega_child mega-lg mega-right">
                        <ul>
                            ...
                            <li><a href="<?php print PATH_FROM_ROOT; ?>/library/">Law</a></li>
                    ...
                    <div class="mega_child mega-lg mega-right-special">
                      <ul>
                       ...
                       <ul>                               
                        ...
                        <div class="mega_feature">
                          <img src="<?php print THEME_BASE_DIR; ?>/images/essential10-thumb.jpg" alt="Essential 10" /><br />
                ...
                <!-- begin accounts mega menu -->
                  <div class="mega_child mega-sm mega-right-special2">
                      ...
                      <ul>
                        <!--<li><a href="https://miami-primo.hosted.exlibrisgroup.com/primo_library/libweb/action/login.do?loginFn=signin&vid=uml&targetURL=http:%2F%2Fmiami-primo.hosted.exlibrisgroup.com%2Fprimo_library%2Flibweb%2Faction%2Fsearch.do%3Fvid%3Duml%26amp;dscnt%3D0%26amp;afterTimeout%3DE08029BDF7C2992FC31D8ACB97398E2E%26amp;dstmp%3D1463604331494%26amp;initializeIndex%3Dtrue&isMobile=false">MyLibrary</a></li>-->          
                        <li><a href="https://miami-primo.hosted.exlibrisgroup.com/primo_library/libweb/action/myAccountMenu.do?vid=uml&fromLink=gotoMyAccountUI">MyLibrary</a></li>          
